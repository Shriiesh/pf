...
def main():
    ...
    while no_change_loop < 20:
        ...
        best_was = best_dist
        loop = loop + 1
        # neighbours = get_neighbours(sim_mean1, np.array(step))
        ...
        #         print("sim_mean1", sim_mean1, "sim_var1:", sim_var1)
        #         print("sim_mean2", sim_mean2, "sim_var2:", sim_var2)
        #         print("Total dist:", best_dist)
        #         dist_list.append(best_dist)
        #         # param_list.append([[sim_mean1, sim_mean2, sim_var1, sim_var2, best_dist]])
        # sim_mean1 = best_mean1
        #
        # neighbours = get_neighbours(sim_mean2, np.array(step))
        # for i in range(len(neighbours)):
        ...
        if best_dist == best_was:
            ...
            # var1 = abs(var1 - np.array([0.0, 0.1]))
            # var2 = abs(var2 - np.array([0.2, 0.2]))
